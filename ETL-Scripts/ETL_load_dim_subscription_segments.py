...
def main():
    ...
    try:
        ...
        svod_status = sys.argv[5]
        live_status = sys.argv[6]
        print("Read parameters are {} {} {} {} {} {} {}".format(default_schema,prod_schema,live_snapshot_date,svod_snapshot_date,svod_status,live_status))
        ...
        #lookup for segments
        #######################################
        dim_seg = spark.sql("SELECT segment_id as metadata_seg_id, segment_name as metadata_seg_name,segment_type FROM {}.dim_segments".format(prod_schema))
    ...
    try:
        ...
        ######################################################
        spark.sql("""
        INSERT OVERWRITE TABLE {}.dim_subscription_segments_snapshot partition (snapshot_date,release_version,segment_type)
